                ...
                <div className="inner-wrapper">
                    ...
                    <div id="forum" ref={forumRef} className="inner-main">
                        ...
                        <div className="inner-main-body p-2 p-sm-3 collapse forum-content show">
                            {blogs.map(blog => {
                                const nonDeletedCommentsCount = blog.comments
                                    ? blog.comments.filter(comment => comment.deletedAt == null).length
                                    : 0;
                                            ...
                                            <div className="media forum-item">
                                                ...
                                                <div className="text-muted small text-center align-self-center">
                                                    <Link to={`/blogs/${blog.id}`}>
                                                        <i className="far fa-comment ml-2"></i> {nonDeletedCommentsCount} Comments
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
