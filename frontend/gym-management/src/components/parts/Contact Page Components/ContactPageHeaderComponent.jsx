...
const ContactHeaderComponent = () => {
  return (
    <header className="header-bg-contact py-5">
    <div className="container px-5">
        <div className="row gx-5 justify-content-center">
            <div className="col-lg-6">
                <div className="text-center my-5">
                    <h1 className="display-5 fw-bolder text-white mb-2">{Statics.contactHeaderTitle}</h1>
                    <p className="lead text-white-50 mb-4">{Statics.contactHeaderDesc}</p>
